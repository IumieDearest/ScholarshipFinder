          ...
          <div className="relative">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-gray-900 truncate">{userInfo.name || "School"}</p>
                <p className="text-xs text-gray-500 truncate">{userInfo.email || "school@email.com"}</p>
              </div>
            </button>
