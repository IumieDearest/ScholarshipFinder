                      ...
                      <tr key={i} className="border-b border-gray-50 last:border-0">
                        ...
                        <td className="py-3">
                          <span className={`text-xs font-semibold px-2 py-0.5 rounded ${
                            h.status === "DENIED" ? "text-red-600 bg-red-50" : "text-green-600 bg-green-50"
                          }`}>
                            {h.status}
                          </span>
                        </td>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-bold text-gray-800 text-sm">Missing Documents</h3>
                </div>
                <div className="space-y-2 mb-4">
                  <div className="flex gap-3 p-3 bg-red-50 border border-red-100 rounded-xl">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-gray-700">Income Statement</p>
                      <p className="text-xs text-red-500">Required for APP-9921</p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 bg-gray-50 border border-gray-100 rounded-xl">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-gray-700">Recommendation Letter</p>
                      <p className="text-xs text-gray-400">Due in 4 days</p>
                    </div>
                  </div>
                </div>
                <button className="w-full border border-gray-200 text-gray-700 text-xs font-semibold py-2.5 rounded-lg hover:bg-gray-50 transition-colors">
                  Upload Documents
                </button>
              </div>
